 ...
 *    - removed redundancy and duplication in getConnection and search 
 *      functions by removing getConnection
 *    - moved the packetisation and depacketisation code to a separate 
 *      structure called MessagingLayer in the file messaging-layer.sml
 *    - renamed communication_device to channel
 *    - renamed file from new-sock-interface.sml to conn-management-layer.sml  
      10/06/2003: Added can receive function
 *)
...
(* For ease of use, open this structure. *)
